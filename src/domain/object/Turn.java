...
public class Turn {
    ...
    public boolean constructAttack(Territory from, Territory to, int type, Integer n){
        // @requires attackers territory, the opponents territory which attacker selected to attack
        // attack option selected as int and number of army willing to sacrifice if necessary (can be null)
        //@effects create attack object with desired parameters and return true if created successfully.
        ...
        boolean control4 = (from.getNumOfArmy() > 2);
    ...
    public boolean attack(){
        // @effects if attack results in conquering opponents territory return true.
